  ...
  <div align="center">
    <table width="749" border="1">
      ...
      <?php  
        ...
        <td><a href="check_answer.php?id=<?php echo $rows['id']; ?>"><!--click to check see answer --></a> |<button style ="background-color:yellow"> <a href="yes_no.php?idt=<?php echo $rows['nom']; ?>">?</a></button></td>
      </tr>
      <?php  } ?>
    </table>
  </div>
